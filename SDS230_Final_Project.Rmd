...
Next, we will reformat the year variable to include only the year as oppossed to year-month while finding the yearly averages for the "BEME" and "size" dataframes, while fining total yearly return for the "returns" dataframe. We then adjust the dataframes so the years line up correctly. 
```{r, include=FALSE}
...
#TukeyHSD(aov2)
par(mar=c(5,11,4,1))
plot(TukeyHSD(aov2), las=1, cex.axis = 0.8)
```
```{r, include=FALSE}
