...
```{r}
newdf <- newdf[newdf$Year <= 1979,]
```

Using our new dataframe, we first examine the average returns per composite industry by year from 1926-1979
```{r}
plot(newdf$indreturnscomp ~ newdf$Year, main = "Scatterplot of Year versus Average Yearly Returns", pch = 24, col = factor(newdf$CompInd), xlab = "Year", ylab = "Average Yearly Returns")
#ADD CONNECTING LINES
```

Neehar, if you want to make some more random graphs, it would be helpful
