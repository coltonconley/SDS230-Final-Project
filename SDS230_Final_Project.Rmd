...
t.test(single$Composite_Beta_TMT, single$Composite_Beta_Com)
```
[ANALYSIS]
...
[Create bootstrap for the correlation for the strongest correlation? - homework 5]

TUKEY COMPARISON FOR SIGNIFICANT COMPARISONS - use the old dataframe and subset for composite columns [Homework 7]

###Permutation Test 

Do it for a different correlation than above 

###Multiple Regressions
[COLTON]

###ANOVA, Logit, Multinomial, or Webscraping 
ANOVA HERE instead of other methods - for composite industry
