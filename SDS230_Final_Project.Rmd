...
Next, we will reformat the monthly date variables in the Returns and Size dataframes 
```{r}
...
Finally, we will create composite industry variables to represent more general sectors. 
